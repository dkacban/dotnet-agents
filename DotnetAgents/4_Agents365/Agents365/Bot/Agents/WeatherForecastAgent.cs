...
using Agents365.Bot.Plugins;

namespace Agents365.Bot.Agents;
...
public class WeatherForecastAgent
{
    ...
    public WeatherForecastAgent(Kernel kernel, IServiceProvider service)
    {
        ...
        _agent.Kernel.Plugins.Add(KernelPluginFactory.CreateFromType<SMSPlugin>(serviceProvider: service));
