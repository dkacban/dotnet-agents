...
public class AdaptiveCardPlugin
{
    private const string Instructions = """
        ...
        that displays the information in a visually appealing way. 
        Adaptive card should alsways have dark-gray color.
        Make sure to only return the valid adaptive card
